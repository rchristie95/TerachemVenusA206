...
\emph{The Journal of Physical Chemistry}. We have revised the manuscript
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  single minimised geometry but as a room-temperature thermal distribution over a
  200-frame restrained NVT ensemble.
...
is now averaged over a 200-frame restrained NVT trajectory, giving
$J = 96 \pm 2~\mathrm{cm^{-1}}$ (a $\sim3\%$ spread) rather than a single-structure
...
\response{We have added conformational sampling. The coupling is now evaluated on 200
snapshots from a restrained NVT trajectory about the physiological interface, giving
$J = 96 \pm 2~\mathrm{cm^{-1}}$ with the inter-dipole angle and centroid separation
...
200-frame restrained NVT ensemble rather than a single minimised structure, yielding
$J = 96 \pm 2~\mathrm{cm^{-1}}$ and demonstrating that the value is stable
($\sim3\%$ variation) with respect to thermal and protonation-independent geometric
disorder about the bound interface.}
