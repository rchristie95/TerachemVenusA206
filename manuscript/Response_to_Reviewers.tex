...
\response{We have adjusted the framing in the Introduction. We now state
...
$J = 111 \pm 3~\mathrm{cm^{-1}}$ with the centroid separation tightly clustered. The coupling varies by only $\sim3\%$, so the reported value is
...
the site-basis coherence $|\rho_{12}|$ shown in panels (b) and (e), and the surrounding text
...
reference (the deprotonated CR2 chromophore, its first-shell residues and the five
nearest waters, including hydrogen link-atom caps), and a reduced
