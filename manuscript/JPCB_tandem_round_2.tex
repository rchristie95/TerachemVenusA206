...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.92\textwidth]{Fig_FrameDynamics.pdf}
  \caption{Open-system dynamics on the two extreme members of the site-energy ensemble, rather than on its mean. Top row, frame $465$: $\Delta = +12.9~\mathrm{cm^{-1}}$, the smallest detuning sampled, giving $\Omega = 66.9~\mathrm{cm^{-1}}$, mixing $2|J|/\Omega = 0.981$ and $40.4\%$ of the bright eigenstate on the minor site --- an accidental near-degeneracy, and the only condition under which the delocalised picture holds. Bottom row, frame $1005$: $\Delta = -1825~\mathrm{cm^{-1}}$, the largest detuning sampled, giving $\Omega = 1826~\mathrm{cm^{-1}}$, mixing $0.036$ and $0.03\%$ on the minor site, so the excitation is on one chromophore and the partner is a spectator. Left, site populations from the master equation; centre, the site-basis coherence $|\rho_{AB}|$; right, three individual diffusive trajectories (thin) against the ensemble average (dashed). All panels use $J = 32.82~\mathrm{cm^{-1}}$ and pure dephasing at $T_2^* = 60$\,fs. The near-degenerate frame exchanges population completely and carries a large transient coherence; the detuned frame does neither. Because the median $|\Delta|$ of the ensemble is several hundred $\mathrm{cm^{-1}}$, the lower row is the typical case.}
