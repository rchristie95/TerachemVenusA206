% SUPERSEDED HISTORICAL SOURCE (arXiv v1, 21 April 2026).
% Its TDC values use an incorrect reciprocal-distance conversion. Do not use
% its numerical coupling or near-field interpretation; see JPCB_tandem_round_2.tex and
% the repository README for the audited 8 August 2026 correction.
...
\noindent\fcolorbox{red!75!black}{yellow!18}{%
\parbox{0.92\columnwidth}{\centering\bfseries
SUPERSEDED---DO NOT SUBMIT\\[2pt]
This historical arXiv-v1 manuscript contains an incorrect reciprocal-length
conversion in the TDC calculation. Use \texttt{JPCB\_tandem\_round\_2.pdf}; the audited
ensemble result is $J=32.8\pm1.6~\mathrm{cm^{-1}}$ and TDC/PDA $=1.19$.}}
\medskip
