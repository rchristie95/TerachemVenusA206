...
cmd.hide("everything")
cmd.dss("dimer_ref")                                   # assign SS so barrels render
cmd.show("cartoon", "dimer_ref"); cmd.color("yellow", "dimer_ref")
for q in ("qmA", "qmB"):
    cmd.show("sticks", q)
util.cbaw("qmA or qmB"); cmd.color("gray90", "(qmA or qmB) and elem C")
...
cmd.ray(W, H)
cmd.png(f"{OUT}/toc_steom.png", dpi=300)
print("wrote toc_steom.png", W, "x", H)
